...
from cycle_contrast.datasets import ImageNetVal
...
def main_worker(gpu, ngpus_per_node, args):
    ...
    if args.dataset == 'imagenet100':
        ...
        print('class name to idx', train_dataset.class_to_idx)
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        if epoch % args.eval_interval == args.eval_interval - 1:
            ...
            epoch_time_str = str(datetime.timedelta(seconds=int(time.time() - ep_start_time)))
            print('Validate Epoch {} time {}'.format(epoch, epoch_time_str))
        ...
        if not args.multiprocessing_distributed or (args.multiprocessing_distributed
            ...
            }, is_best, filename='checkpoint_lincls.pth.tar', path=args.save_dir)
